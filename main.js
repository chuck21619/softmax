...
document.addEventListener('DOMContentLoaded', function () {
    ...
    trainButton.onclick = () => {
        data.fetchTrainingData((games) => {
            ...
            const { shuffledGames, repeatedWinners } = data.shuffleGamesAndRepeatWinners(cleanedGames, winners);
            console.log("shuffledGames:", shuffledGames);
            console.log("repeatedWinners:", repeatedWinners);
            const { playerTensor, deckTensor } = data.inputTensorsFromCleanedGames(shuffledGames, players, decks);
            playerTensor.print();
            deckTensor.print();
            const targetTensor = data.targetTensorFromWinners(repeatedWinners, players);
            targetTensor.print();
